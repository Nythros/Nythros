 ...
 * The match-join orchestration delegation contract (framework → starter-kit inversion): after a successful match,
 * one candidate is orchestrated into the designated room.
 *
 * 组装边界（R3 玩法批裁决）：transfer 全链编排——宿主世界 EM/AOI 摘除、entity_leave 广播、
 * manager->transfer 原子入房与连接容器维度标记——全部依赖宿主 World/MapServer 能力，留在 starter-kit
 ...
 * World/MapServer capabilities and stay in starter-kit (the single-assembly-point rule); this contract exposes only
